  ...
  #bindForms() {
    if (this.signinForm) {
      this.signinForm.addEventListener("submit", (event) => {
        ...
        this.session.login({ email: email.value });
        this.#success(this.signinForm);
      });
    }
    ...
    if (this.registerForm) {
      this.registerForm.addEventListener("submit", (event) => {
        ...
        this.session.login({ name: name.value.trim(), email: email.value });
        this.#success(this.registerForm);
      });
    }
  }
